...
contract WTRXTokenWrapper {
    ...
    IERC20 public y = IERC20(0x41891CDB91D149F23B1A45D9C5CA78A88D0CB44C18); // Staking Token Address
...
contract WtrxPool is WTRXTokenWrapper, IRewardDistributionRecipient {
